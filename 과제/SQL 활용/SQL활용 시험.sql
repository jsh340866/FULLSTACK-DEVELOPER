...
alter table tbl_member add constraint PK_member_id
primary key(member_id);
alter table tbl_book add constraint PK_bookcode_id 
primary key(book_code);



alter table tbl_rental add constraint PK_rental_id 
