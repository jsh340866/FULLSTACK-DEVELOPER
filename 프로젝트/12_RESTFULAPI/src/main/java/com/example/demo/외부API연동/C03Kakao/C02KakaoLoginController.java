...
public class C02KakaoLoginController {
    ...
    private String REDIRECT_URI="http://192.168.5.14:8080/Kakao/callback";
    private String LOGOUT_REDIRECT_URI="http://192.168.5.14:8080/Kakao/login";
...
//        params.add("","");
    ...
    public void message_friends(@PathVariable String message)
    {
        ...
        List<Element> els = kakaoFriendsResponse.getElements();
        String[] uuids = els.stream()
                .map(el -> el.getUuid())
